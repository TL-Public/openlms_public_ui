	...
	<nav class="flex flex-row flex-wrap">
		{#each tabs as tab}
			<button
				...
				class=" whitespace-nowrap cursor-pointer border-b-2 px-4 py-3 text-sm font-medium text-darkGray hover:border-accent-hover hover:text-gray-700 {tab?.text ===activeTabText
					? 'border-accent'
					: 'border-transparent'}"
			>
