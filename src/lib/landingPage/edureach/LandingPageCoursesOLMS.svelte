<script>
	...
	import Tabs from '$lib/landingPage/edureach/TabsOLMS.svelte';
	import HorizontalScroll from '$lib/landingPage/edureach/horizontalScrollOLMS.svelte';
...
<div class=" relative px-4 pb-16 sm:pb-24 sm:px-6 lg:px-12 lg:py-24 py-12 bg-white" id="course-area">
	<div class="relative mx-auto max-w-7xl">
		<div class=" font-bold text-primary mb-4 sm:mb-6 flex items-center gap-2">
			...
			<h2
				class="text-base sm:text-2xl text-primary font-bold leading-normal sm:leading-2 uppercase"
			>
				{$_('ExploreAndGetStarted')}
			</h2>
		</div>
		<div class="relative mx-auto max-w-7xl mb-4 hidden sm:block text-darkGray">
	...
	<div class="flex justify-center pt-8">
		<a
			href="/courses"
			class="inline-flex items-center justify-center px-8 py-3 bg-secondary text-base text-white font-semibold rounded-md hover:bg-opacity-90 transition-colors duration-200 w-fit self-center md:self-start"
			>{$_('ViewAllCourses')}</a
		>
	</div>
</div>
