<script>
	import CourseListMainSection from '$lib/courseListing/CourseListMainSection.svelte';
...
<div
	class="bg-blue-20 px-4 pt-4 pb-8 mx-4 mb-8 mt-0 lg:mx-[92px] lg:mb-9 lg:mt-0 lg:px-9 lg:pb-9 lg:pt-6 rounded-lg"
>
	<div class="pb-4 lg:pb-6">
		<BreadCrumbs {route} {params} />
	</div>
	<div class="w-full flex flex-col gap-3 justify-center lg:grid lg:grid-cols-2 lg:grid-rows-1">
		<div class="flex flex-col">
			<h1 class="text-primary font-bold text-base lg:text-2xl mb-2">{$_('Courses')}</h1>
