...
<div class=" relative">
	<div class="relative mx-auto max-w-7xl">
		<div
			class="grid grid-flow-col auto-cols-[minmax(min(255px,100%),255px)] pb-3 gap-2 sm:gap-4 overflow-x-auto relative scroll-smooth customized-scrollbar snap-inline"
