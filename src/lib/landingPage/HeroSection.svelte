...
<div class="bg-primary">
	<div
		class=" flex w-full box-border h-[50vh] md:h-[65vh] max-h-[550px] overflow-hidden  bg-ivory sm:mt-0 2xl:max-w-7xl 2xl:mx-auto"
	>
		...
		>
			<svg
				...
				class="size-20 bp-900px:size-36 fill-accent group-hover:fill-white80 group-hover:opacity-50"
			>
				<path
